...
def go_repositories():
    ...
    go_repository(
        name = "com_github_go_shiori_go_readability",
        importpath = "github.com/go-shiori/go-readability",
        sum = "h1:fv8CHMcb1aQalT0Ms8g+MgIje1LgO6dm83Xek1jEn2s=",
        version = "v0.0.0-20190829113304-8630e8f6e148",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:EZofHp/BzEf3j39/+7CX1JvH0WaPG+ikBrqAdAPf+GM=",
        version = "v0.0.0-20190520210107-018c4d40a106",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:NXfmMfXz6JqGfG3ikSxcz2N93j6DgScr19Oo2uwFu88=",
        version = "v0.0.0-20190520201301-c432e742b0af",
    )
    go_repository(
