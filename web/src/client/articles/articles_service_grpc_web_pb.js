 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.app.miniboard.users.articles.v1.CreateArticleRequest,
 *   !proto.app.miniboard.users.articles.v1.Article>}
 */
const methodDescriptor_ArticlesService_CreateArticle = new grpc.web.MethodDescriptor(
  '/app.miniboard.users.articles.v1.ArticlesService/CreateArticle',
  grpc.web.MethodType.UNARY,
  proto.app.miniboard.users.articles.v1.CreateArticleRequest,
  proto.app.miniboard.users.articles.v1.Article,
  /**
   * @param {!proto.app.miniboard.users.articles.v1.CreateArticleRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
 ...
 *   !proto.app.miniboard.users.articles.v1.Article>}
 */
const methodInfo_ArticlesService_CreateArticle = new grpc.web.AbstractClientBase.MethodInfo(
  proto.app.miniboard.users.articles.v1.Article,
  /**
   * @param {!proto.app.miniboard.users.articles.v1.CreateArticleRequest} request
   * @return {!Uint8Array}
...
/**
 * @param {!proto.app.miniboard.users.articles.v1.CreateArticleRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 ...
 *     The XHR Node Readable Stream
 */
proto.app.miniboard.users.articles.v1.ArticlesServiceClient.prototype.createArticle =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/app.miniboard.users.articles.v1.ArticlesService/CreateArticle',
      request,
      metadata || {},
      methodDescriptor_ArticlesService_CreateArticle,
      callback);
};
 ...
 *     A native promise that resolves to the response
 */
proto.app.miniboard.users.articles.v1.ArticlesServicePromiseClient.prototype.createArticle =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/app.miniboard.users.articles.v1.ArticlesService/CreateArticle',
      request,
